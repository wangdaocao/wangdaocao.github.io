  ...
  return function (e) {
    ...
    */
    ...
    e.exports = {
      ...
      mail: "邮箱(必填)",
      link: "网址(http://)",
      nickFail: "昵称不能少于1个字符呦",
      mailFail: "请填写正确的邮件地址哇",
      sofa: "来了老弟~",
      submit: "提交",
      reply: "回复",
      cancelReply: "取消回复",
